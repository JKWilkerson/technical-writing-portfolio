...
## Samples from _Developing Oracle JET Apps Using MVVM Architecture_ and _Developing Oracle JET Apps Using Virtual DOM Architecture_
...
## Samples from _Using Visual Builder Studio_
...
## Samples from _What's New in Oracle JET_

These are some samples from a publication called _What's New in Oracle JET_, which is created with each new release of the Oracle JavaScript Extension Toolkit (JET) to inform JET developers of notable changes to the toolkit and its documentation.
